"""
Stage 2/Group B Streamlit Task App

This script implements the interactive Group B coding task interface for participants
...
2. Session Initialisation:
   - Initialises session state variables for tracking task progress, timing, and
     completion status for Task 1 and Task 2.
   - Generates a DataFrame for use in tasks (time-stamped speed data).
...
def save_task_dat():
    ...
    # Participants on this page are in Group B.
    group = "B"
        ...
        # Debrief information shown to participants once Task 2 is complete.
            ...
            **Remember you will need your memorable word for the final survey.**
            ...
            if not st.session_state.get("results_saved", False):
                # Calling the function to save task data.
                save_task_dat()
                # Setting "results_saved" to True to avoid re-saving.
